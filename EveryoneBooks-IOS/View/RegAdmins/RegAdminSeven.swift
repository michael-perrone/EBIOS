...
class RegAdminSeven: UIView {
    ...
    private let employeeQuestionText: UITextView = {
        let uitv = Components().createSimpleText(text: "Will your employees be working predetermined shifts from one set time to another? (Click the question mark to the bottom left and scroll to step 10 for details.)");
        uitv.font = .systemFont(ofSize: 18);
